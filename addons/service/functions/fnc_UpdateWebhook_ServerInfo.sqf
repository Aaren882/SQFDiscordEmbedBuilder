...
/* ----------------------------------------------------------------------------
Function: DiscordAPI_service_fnc_UpdateWebhook_ServerInfo
Description:
...
Examples
    (begin example)
        [false] call DiscordAPI_service_fnc_UpdateWebhook_ServerInfo
    (end)
...
TRACE_1("fnc_UpdateWebhook_ServerInfo",_this);
...
private _infoList = FUNC(GetServerInfo);
